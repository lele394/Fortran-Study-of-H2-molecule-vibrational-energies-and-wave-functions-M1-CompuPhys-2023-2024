...
! same as given program, only exposes JLEV and ENERG
   ! why does it seems like JLEV is not taken into account
   ...
   INTEGER(KIND=4):: NCMAX, IFLAG, M, JLEV, NCOUNT, NODE
   ...
   REAL(KIND=8):: R0, RN, A, B, EPS, TOL, FINIT, ENERG, H, HC, E, DE
    ...
    FINIT/0.D0/, ENERG/-0.9502D0/, NCMAX/30/, IFLAG/1/, M/11/, JLEV/0/
